...
function About () {
  ...
  return (
    <div className="Page about-page">
      ...
      <p className="about-para">If you are a developer looking to colloborate on a project then I would be very interested to hear your ideas.  You have access the code for this website on my GitHub page: <a href="https://github.com/lwlsimm/my-reading-hub" target="_blank" rel="noreferrer">www.github.com/lwlsimm/my-reading-hub</a>.</p>
